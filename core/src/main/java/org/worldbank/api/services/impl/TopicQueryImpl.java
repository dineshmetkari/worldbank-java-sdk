...
/**
 * The Class TopicQueryImpl.
 */
public class TopicQueryImpl extends BaseWorldBankQuery<Topic> implements
	TopicQuery {
	...
	@Override
	public void reset() {
		apiUrlBuilder = createWorldBankApiUrlBuilder(WorldBankApiUrls.TOPICS_URL);
	}
	 ...
	 */
	@Override
	protected Topic unmarshall(JsonElement response) {
