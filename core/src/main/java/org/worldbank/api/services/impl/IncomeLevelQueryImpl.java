 ...
 */
public class IncomeLevelQueryImpl extends BaseWorldBankQuery<IncomeLevel> implements
	IncomeLevelQuery {
	...
	@Override
	public void reset() {
		apiUrlBuilder = createWorldBankApiUrlBuilder(WorldBankApiUrls.INCOME_LEVELS_URL);
	}
