...
import org.worldbank.api.services.CountryQuery;
 ...
 */
public class CountryQueryImpl extends BaseWorldBankQuery<Country> implements
	CountryQuery {
	...
	@Override
	public void reset() {
		apiUrlBuilder = createWorldBankApiUrlBuilder(WorldBankApiUrls.COUNTRIES_URL);
	}
