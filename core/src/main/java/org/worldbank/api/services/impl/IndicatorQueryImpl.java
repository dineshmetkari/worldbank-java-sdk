...
import org.worldbank.api.services.IndicatorQuery;
 ...
 */
public class IndicatorQueryImpl extends BaseWorldBankQuery<Indicator> implements
	IndicatorQuery {
	...
	@Override
	public void reset() {
		apiUrlBuilder = createWorldBankApiUrlBuilder(WorldBankApiUrls.INDICATORS_URL);
	}
