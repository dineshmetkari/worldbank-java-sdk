...
/**
 * The Class LendingTypeQueryImpl.
 */
public class LendingTypeQueryImpl extends BaseWorldBankQuery<LendingType> implements
	LendingTypeQuery {
	...
	@Override
	public void reset() {
		apiUrlBuilder = createWorldBankApiUrlBuilder(WorldBankApiUrls.LENDING_TYPES_URL);
	}
	 ...
	 */
	@Override
	protected LendingType unmarshall(JsonElement response) {
		Gson gson = getGsonBuilder().create();
		return gson.fromJson(response, LendingType.class);
	}
